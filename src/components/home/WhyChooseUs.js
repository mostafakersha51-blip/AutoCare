      ...
      <div className="container mx-auto px-6 md:px-8">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            <img src="https://i.ibb.co/nFLNzT1/Logo.png" alt="Why Choose Us" className="rounded-lg shadow-lg" />
          </div>
          
          <div className="lg:w-1/2 lg:pl-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Why Choose AutoCare?</h2>
