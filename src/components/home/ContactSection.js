            ...
            <div className="space-y-6">
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">
                    Customer Support: <a href="tel:+11234567890" className="hover:text-blue-600">+20 (10) 123-456-78</a><br />
                    Emergency: <a href="tel:+11234567899" className="hover:text-blue-600">+20 (12) 345-678-91</a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">
                    General Inquiries: <a href="mailto:info@AutoCare.com" className="hover:text-blue-600">info@AutoCare.com</a><br />
                    Support: <a href="mailto:support@AutoCare.com" className="hover:text-blue-600">support@AutoCare.com</a>
                  </p>
                </div>
              </div>
